...
public class NMSHandlerFactory {
    ...
    public static NMSHandler loadNMS() {
        ...
        return switch (version) {
            ...
            case "1.20.5-R0.1-SNAPSHOT", "1.20.6-R0.1-SNAPSHOT" -> new io.lumpq126.eclipsia.nms.v1_20_R4.NMSHandlerImpl();
            case "1.21-R0.1-SNAPSHOT", "1.21.1-R0.1-SNAPSHOT" -> new io.lumpq126.eclipsia.nms.v1_21_R1.NMSHandlerImpl();
            case "1.21.2-R0.1-SNAPSHOT", "1.21.3-R0.1-SNAPSHOT" -> new io.lumpq126.eclipsia.nms.v1_21_R2.NMSHandlerImpl();
            case "1.21.4-R0.1-SNAPSHOT" -> new io.lumpq126.eclipsia.nms.v1_21_R3.NMSHandlerImpl();
            case "1.21.5-R0.1-SNAPSHOT" -> new io.lumpq126.eclipsia.nms.v1_21_R4.NMSHandlerImpl();
            case "1.21.6-R0.1-SNAPSHOT", "1.21.7-R0.1-SNAPSHOT", "1.21.8-R0.1-SNAPSHOT" -> new io.lumpq126.eclipsia.nms.v1_21_R5.NMSHandlerImpl();
